...
import { Star, GitFork, ExternalLink, Github, BarChart3, Archive, Edit, Trash2, Play, Calendar } from 'lucide-react';
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-shrink-0">
                <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-blue-600 rounded-lg overflow-hidden">
                  <img
                    src={project.image}
                    alt={project.name}
